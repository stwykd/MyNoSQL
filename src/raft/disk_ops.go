...
func (r *Raft) decode(data []byte) {
	...
	r.currentTerm, r.votedFor, r.snapshotIdx, r.logIndex, r.commitIndex, r.lastApplied = currentTerm, votedFor, lastIncludedIndex, logIndex, commitIndex, lastApplied
}
